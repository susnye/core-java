...
CREATE TABLE `arrowhead_cloud` (
  ...
  `is_neighbor` int(1) NOT NULL DEFAULT 0,
  `is_own_cloud` int(1) NOT NULL DEFAULT 0,
...
CREATE TABLE `arrowhead_service` (
  ...
  CONSTRAINT `InterfaceIdFK` FOREIGN KEY (`interface_id`) REFERENCES `arrowhead_service_interfaces` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

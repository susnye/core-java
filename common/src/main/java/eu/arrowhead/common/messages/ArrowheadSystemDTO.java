...
public class ArrowheadSystemDTO {
  ...
  public ArrowheadSystemDTO() {
  }

  public ArrowheadSystemDTO(String systemName, String address, Integer port, String authenticationInfo) {
  ...
  public ArrowheadSystemDTO(String json) {
  ...
  public ArrowheadSystemDTO(ArrowheadSystemSupport system) {
  ...
  public ArrowheadSystemDTO(ArrowheadSystemDTO system) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ArrowheadSystemDTO)) {
      return false;
    }
    ArrowheadSystemDTO that = (ArrowheadSystemDTO) o;
  ...
  public void partialUpdate(ArrowheadSystemDTO other) {
